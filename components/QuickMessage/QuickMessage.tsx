...
const QuickMessage = () => {
  return (<>
  <section className="body-font bg-gray-900 text-gray-400 bg-no-repeat bg-[url('/assets/quick-bg.jpg')] bg-cover">

<div className="container mx-auto px-5 py-24 ">
  
  <div className="mb-12 flex w-full flex-col text-center">
    <h1 className="title-font mb-4 text-2xl font-medium text-white sm:text-3xl">Contact Us</h1>
    <p className="mx-auto text-base leading-relaxed lg:w-2/3 text-white font-semibold">Feel free to reach out to us! Whether you have a question,
